...
### HINT
&nbsp;&nbsp;&nbsp;&nbsp;In order to achieve the synchronization, please think how many semaphores should be used. Then use create_sem() in p1.c to create all the semaphores and their initial values.