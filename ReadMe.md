...
To coordinate p1, p2 and p3, you are only allowed to use P(), V() for the lab. You are not allowed to use any other statements such as IF or use additional variables, 
