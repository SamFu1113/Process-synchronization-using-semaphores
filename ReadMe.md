...
## Notes
&nbsp;&nbsp;In order to achieve the goal, I need to think of some ways to use semaphore to coordinate the processes. Try to let `p1` prints message once first.  After that, `p2` is allowed to print message.
